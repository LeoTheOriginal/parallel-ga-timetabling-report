...
\begin{tikzpicture}[
    ...
    out/.style={draw, rounded corners=3pt, fill=danger, minimum width=1.8cm, minimum height=0.55cm, align=center, font=\tiny, thick},
...
% Layer 6
\node[out, minimum width=2.2cm] (timetable)  at (1.5, -2.7) {\texttt{timetable.txt}};
\node[out, minimum width=2.2cm] (schedule)   at (1.5, -3.5) {\texttt{schedule.csv}};
\node[out, minimum width=2.2cm] (conv_out)   at (1.5, -4.3) {\texttt{convergence\_rankN.csv}};
% arrows
\draw[arr] (raw) -- (conv);
